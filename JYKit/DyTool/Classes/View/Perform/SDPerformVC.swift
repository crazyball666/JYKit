...
class SDPerformVC: DYBaseVC {
    ...
    override func viewDidLoad() {
        ...
        NSLayoutConstraint.activate([
            ...
            cpuView.heightAnchor.constraint(equalTo: view.heightAnchor, multiplier: 0.5),
            cpuView.leftAnchor.constraint(equalTo: view.leftAnchor),
            cpuView.topAnchor.constraint(equalTo: view.topAnchor),
